...
const styles: any = {
  ...
  joinButton: {
    ...
    justifyContent: "center",
    gap: 10,
    boxShadow: "0 14px 24px rgba(25,195,125,0.25)",
    cursor: "pointer",
  },
  headerBar: {
    height: 70,
  ...
  heatmapToggle: {
    ...
    padding: "12px 18px",
    minWidth: 140,
    boxShadow: "0 12px 24px rgba(52,211,153,0.25)",
    cursor: "pointer",
    flex: "0 0 auto",
  },
  heatmapToggleOff: {
  ...
  adminCard: {
    ...
    borderRadius: 26,
    padding: "18px 16px",
    boxShadow: "0 12px 26px rgba(22,37,68,0.24)",
  },
  adminTitle: {
    fontSize: 15,
    fontWeight: 900,
  ...
  uploadButton: {
    ...
    fontWeight: 900,
    fontSize: 16,
    boxShadow: "0 14px 24px rgba(25,195,125,0.22)",
  },
};
